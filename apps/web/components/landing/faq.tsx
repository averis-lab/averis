...
const FAQ = [
  ...
  },
  {
    ...
    a: "The disagreement is reported, with both positions and both evidence trails intact. Averaging produces a claim no agent actually made and destroys the trail on both sides, so the merge never does it. Confidence and consensus are also reported separately, because a cohort can be confidently split.",
  },
  {
